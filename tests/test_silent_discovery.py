...
async def test_silent_logic_buffered():
    ...
    # Mock dependencies
    with patch('src.system.comms_daemon.send_telegram') as mock_send, \
         patch('src.system.logging.Logger') as mock_logger, \
         patch('src.infrastructure.token_scraper.get_token_scraper') as mock_scraper_getter:
