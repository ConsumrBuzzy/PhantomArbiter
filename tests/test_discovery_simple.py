...
class TestDiscoveryEngine(unittest.TestCase):
    ...
    def test_calculate_performance_smart(self):
        ...
        score = loop.run_until_complete(self.engine.calculate_wallet_performance("WalletSmart"))
        loop.close()
    ...
    def _mock_rpc_call_smart(self, method, params):
        ...
        if method == "getTransaction":
            ...
            return {"result": {"meta": {"preBalances": [100], "postBalances": [200], "logMessages": ["Swap"]}, "transaction": {"message": {"accountKeys": ["WalletSmart"]}}}}, None
    ...
    def test_scan_token(self):
        ...
        loop = asyncio.new_event_loop()
        score = loop.run_until_complete(self.engine.scan_token_for_smart_money("TokenMoon"))
        loop.close()
    ...
    def _mock_rpc_call_scan(self, method, params):
        ...
        if method == "getTransaction":
            ...
            return {"result": {"transaction": {"message": {"accountKeys": ["SmartGuy"]}}}}, None
        return None, "Error"
