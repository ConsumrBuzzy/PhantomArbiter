...
# Setup
RPC_URL = (
    "https://api.mainnet-beta.solana.com"  # Default public, will use Helius if env set
)
...
if res and "error" not in res:
    ...
    print(
        f"❌ Failed or Not Supported: {res.get('error', {}).get('message') if res else 'No Response'}"
    )
