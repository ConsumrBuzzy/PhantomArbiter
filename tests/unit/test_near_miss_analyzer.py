...
class TestCalculateMetrics:
    ...
    def test_custom_trade_size(self, near_miss_opp):
        ...
        metrics_30 = NearMissAnalyzer.calculate_metrics(near_miss_opp, trade_size_usd=30.0)
        metrics_100 = NearMissAnalyzer.calculate_metrics(near_miss_opp, trade_size_usd=100.0)
