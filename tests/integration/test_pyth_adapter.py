...
class TestPriceDivergence:
    ...
    def test_divergence_blocks_when_exceeded(self):
        ...
        is_valid, reason, pyth_price = executor._check_price_divergence(mock_watcher, 225.0)
    ...
    def test_divergence_passes_when_small(self):
        ...
        is_valid, reason, pyth_price = executor._check_price_divergence(mock_watcher, 228.60)
