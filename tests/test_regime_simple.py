...
from src.analysis.regime_detector import RegimeDetector, VolatilityRegime, TrendRegime
...
def test_regime():
    ...
    print(f"Result: Vol={regime.volatility}, Trend={regime.trend}, score={regime.quality_score}")
