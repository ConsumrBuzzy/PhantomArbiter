...
| **PortfolioManager**| `src/strategy/portfolio.py` | 🟡 Legacy | Superseded by CapitalManager (V40.0). Still referenced in some tools. |
| **CapitalManager (Dup)**| `src/core/capital_manager.py` | 🔴 Dead | Duplicate of `shared/system`. **Action: Delete**. |
