...
- [x] **Data**: Update `SharedTokenMetadata` schema with lifecycle fields.
- [/] **Infrastructure**: Add Pump.fun WSS filter to `WssAggregator`.
- [ ] **Bridge**: Map OpenBook Market IDs for `RaydiumStandardBridge`.
- [ ] **Core**: Implement `initialize2` log detection in `RaydiumStandardBridge`.
