...
class CongestionMonitor:
    ...
    def __init__(
        ...
        Logger.info(f"🔥 [CONGESTION] Monitor initialized (Base: {self.base_tip}, Max: {self.max_tip}, AbortRatio: {self.max_tip_profit_ratio})")
    ...
    def should_abort_trade(self, expected_profit_usd: float, sol_price: float = None) -> bool:
        """
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "status": "NORMAL" if self.current_multiplier == 1.0 else ("EMERGENCY" if self.current_multiplier >= 5.0 else "ELEVATED"),
