...
class Watcher:
    ...
    def __init__(self, symbol: str, mint: str, validator=None, is_critical=False, lazy_init=False):
        self.symbol = symbol
        self.mint = mint
        self.validator = validator
        # V11.4: Pass lazy_init to DataFeed to skip blocking backfill for Scout tokens
        self.data_feed = DataFeed(mint, symbol, is_critical=is_critical, lazy_init=lazy_init)
