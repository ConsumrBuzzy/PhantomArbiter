...
class Metrics:
    @staticmethod
    def calculate_pnl_pct(entry_price: float, current_price: float, cost_basis: float = 0.0) -> float:
        """
    ...
    @staticmethod
    def calculate_net_pnl_pct(entry_price: float, current_price: float, cost_basis: float) -> float:
        """
