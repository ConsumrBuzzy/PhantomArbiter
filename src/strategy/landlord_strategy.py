...
class LandlordCore:
    ...
    def check_rebalance(self) -> Optional[float]:
        ...
        if divergence > self.REBALANCE_THRESHOLD:
            ...
            print(f"   ⚖️ [LANDLORD] Rebalance needed: ratio={ratio:.3f}, amt=${rebalance_amount:.2f}")
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            "duration_hours": (time.time() - self.state.entry_time) / 3600 if self.state.active else 0
        }
