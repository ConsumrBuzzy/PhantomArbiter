...
def check_route(router: SmartRouter, token_mint: str, symbol: str) -> Dict[str, bool]:
    ...
    routes = {"jupiter": False, "raydium": False, "orca": False, "meteora": False}
    ...
    try:
        ...
        if quote:
            ...
            print(
                f"  ✅ {symbol}: Jupiter route found - Raydium:{routes['raydium']} Orca:{routes['orca']} Meteora:{routes['meteora']}"
            )
        else:
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if pairs:
                ...
                print(
                    f"  🔄 {symbol}: DexScreener fallback - Raydium:{routes['raydium']} Orca:{routes['orca']} Meteora:{routes['meteora']}"
                )
            else:
