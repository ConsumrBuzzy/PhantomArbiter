...
def get_drift_balance(wallet_pubkey: str) -> Optional[DriftBalance]:
    ...
    try:
        ...
        total_collateral = float(data.get("totalCollateralValue", 0)) / (10 ** USDC_DECIMALS)
...
def sign_and_send_tx(tx_base64: str, keypair: Keypair, rpc: SolanaClient) -> Optional[str]:
