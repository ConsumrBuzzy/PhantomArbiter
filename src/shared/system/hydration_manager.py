        ...
        try:
            ...
            if context:
                ...
                if "wallet_key" in safe_context:
                    ...
                    Logger.info(
                        "   🔐 Privacy Shield: Wallet Key scrubbed from archive."
                    )
            ...
            archive_data = {
                ...
                "stats": {
                    ...
                    "net_pnl": sum(t.get("profit_amount", 0) for t in trades)
                    if trades
                    else 0.0,
                },
                "ledger": trades,
            ...
            Logger.info(
                f"   ✅ Dehydration Complete: {filename} ({len(trades)} trades archived)"
            )
            return filename
    ...
    def rehydrate(self, archive_path: str) -> bool:
        ...
        try:
            ...
            for trade in trades:
                ...
                sql = (
                    f"INSERT OR IGNORE INTO trades ({columns}) VALUES ({placeholders})"
                )
