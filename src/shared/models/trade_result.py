...
class TradeResult:
    ...
    @classmethod
    def from_paper_result(cls, result: dict, token: str, action: str, 
                          requested_price: float) -> "TradeResult":
        """
    ...
    @classmethod
    def failed(cls, token: str, action: str, reason: str, 
               source: str = "PAPER") -> "TradeResult":
