...
class PoolRegistry:
    ...
    def update_coverage(
        ...
        try:
            ...
            if has_raydium is not None:
                coverage.has_raydium = has_raydium
            if has_orca is not None:
                coverage.has_orca = has_orca
            if has_meteora is not None:
                coverage.has_meteora = has_meteora
