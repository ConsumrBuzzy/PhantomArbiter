...
from src.shared.execution.schemas import calculate_arb_strategy, ArbTask
...
async def main():
    ...
    print(f"   Simulated 0.5% arb on 1 SOL:")
    ...
    print(f"   ├─ Profit BPS: {strategy['profit_bps']} ({strategy['profit_bps']/100:.2f}%)")
