...
class PoolPriceWatcher:
    ...
    async def start(self) -> bool:
        ...
        if not self.wss_url:
            Logger.error("[WATCHER] No WSS URL configured. Set HELIUS_WS_URL or HELIUS_API_KEY")
            return False
    ...
    async def _parse_pool_price(self, pool: WatchedPool, result: dict) -> Optional[PoolPrice]:
        """
