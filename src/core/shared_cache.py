...
class SharedPriceCache:
        ...
        try:
             ...
             with lock.acquire(timeout=0.2):
                 ...
                 if symbol not in data["prices"]:
                     data["prices"][symbol] = {"price": 0, "source": "", "timestamp": 0, "history": []}
    ...
    def get_broker_status(cls) -> dict:
        ...
        return {
            ...
            "broker_alive": (time.time() - max(last_update, data.get("broker_heartbeat", 0))) < 60
        }
    ...
    @classmethod
    def write_wallet_state(cls, usdc_balance: float, held_assets: dict, sol_balance: float = 0):
        """
    ...
    @classmethod
    def write_safety(cls, symbol: str, is_safe: bool, liquidity: float = 0.0, reason: str = ""):
        """
