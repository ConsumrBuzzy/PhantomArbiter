...
class ThreadPoolManager:
    ...
    def __init__(self, max_io_workers: int = None):
        ...
        try:
            ...
            max_io_workers = getattr(Settings, 'THREAD_POOL_MAX_WORKERS', default_workers)
        ...
        Logger.info(f"🧵 [THREADS] ThreadPoolManager initialized (max_workers={max_io_workers})")
    ...
    def _start_resource_monitor(self):
                ...
                try:
                    ...
                    if cpu > 85.0 or mem > 90.0:
                        ...
                        if self._throttle_delay == 0.1:
                            Logger.warning(f"🧵 [THREADS] High Load (CPU {cpu}%/MEM {mem}%) - Throttling I/O")
        ...
        self._resource_monitor_thread = threading.Thread(target=monitor, daemon=True, name="ResourceMonitor")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            active_daemons = sum(1 for t in self._daemon_threads.values() if t.is_alive())
    ...
    def list_daemons(self) -> Dict[str, bool]:
        ...
        with self._lock:
            return {
                ...
                for name, thread in self._daemon_threads.items()
            }
