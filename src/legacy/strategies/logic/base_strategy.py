...
from src.legacy.strategies.logic.risk import TrailingStopManager
...
class BaseStrategy(ABC):
    ...
    def calculate_position_size(self, atr: float = 0.0) -> float:
        ...
        available = (
            ...
            if hasattr(self.portfolio, "cash_available")
            else base_size
        )
    ...
    def get_net_pnl_reason(
        self, watcher: Watcher, price: float, base_reason: str
    ) -> str:
