...
class TriangularEngine:
    ...
    async def calculate_cycle_profit(
        self, cycle: List[str], start_amount: float = 100.0
    ...
    async def find_opportunities(
        self, cycles: List[List[str]] = None, start_amount: float = 100.0
    ...
    async def scan_all_cycles(
        self, tokens: List[str] = None, start_amount: float = 100.0
    ) -> List[TriangularOpportunity]:
        """
    ...
    async def execute_cycle(
        self, opportunity: TriangularOpportunity, paper_mode: bool = True
    ) -> Dict[str, Any]:
        """
...
async def run_triangular_demo(budget: float = 100.0):
    ...
    print("   Fee per swap: 0.1% × 3 = 0.3% total")
    print("=" * 70)
    ...
    if profitable:
        ...
        print("   All cycles have negative returns after 0.3% fees")
