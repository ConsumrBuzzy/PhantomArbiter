...
class PhantomDashboard(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        # Note: Swapped inventory to right for balance? Or keep inventory wide?
        # User asked for "Scalp Opps, Hop Opps". Best to give Opps more space.
